...
public:
    ...
    /**
     * @brief InterpolateCurveNetwork interpolated a curve network of guide curves and profiles
     * curves
     * @param profiles The profiles to be interpolated
     * @param guides   The guides curves to be interpolated
     * @param spatialTolerance Maximum allowed distance between each guide and profile (in theory
     * they must intersect)
     */
...
Handle(Geom_BSplineSurface)
    curveNetworkToSurface(const std::vector<Handle(Geom_BSplineCurve)>& profiles,
                          const std::vector<Handle(Geom_BSplineCurve)>& guides,
